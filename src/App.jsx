...
const MEMBERS = [
  ...
  },
  {
    ...
    icon: "⚙️",
    tasks: [
      { id: "b1", day: "Day 1", week: 1, label: "Install Android Studio and write a Java class that stores a student name and grade, then print it" },
      { id: "b2", day: "Day 2", week: 1, label: "Use Postman to send a request to a public API (jsonplaceholder.typicode.com) and read the response" },
      { id: "b3", day: "Day 3", week: 1, label: "Add Retrofit to the app and fetch a list of users from the internet — print the results in the log" },
      { id: "b4", day: "Day 4", week: 1, label: "Send a fake login request (email + password) to a test server and print whether it succeeded or failed" },
      { id: "b5", day: "Day 5", week: 1, label: "Convert the server response text into a usable Java object so the app can actually read the data" },
      { id: "b6", day: "Day 6", week: 2, label: "Make API calls run in the background so the app screen does not freeze while waiting for data" },
      { id: "b7", day: "Day 7", week: 2, label: "After a successful login, save the session so the user stays logged in after closing and reopening the app" },
      { id: "b8", day: "Day 8", week: 2, label: "Show a friendly error message when there is no internet, the server is down, or the login is wrong" },
      { id: "b9", day: "Day 9", week: 2, label: "Build the full login flow: user types credentials, app contacts server, success opens Home, failure shows error" },
      { id: "b10", day: "Day 10", week: 2, label: "Feed the server data into Member A screens so the list and profile display real information from the API" },
    ],
  },
  {
    id: "memberC",
